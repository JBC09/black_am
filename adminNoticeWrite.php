  ...
  <body>
    ...
    <div id="wrap">
      ...
      <div id="left">
        ...
        <ul>    <li><a href="admin.php">회원목록</a></li>
            <li><a href="adminSignList.php">가입요청</a></li>
            <li><a href="adminUserOutList.php">탈퇴목록</a></li></ul>
          

        <ul>
            <li><a href="adminWriteBlack.php">등록블랙정보</a></li>
            <li><a href="adminDeleteBlack.php">삭제블랙정보</a></li></ul>
          

        <ul>
            <li id="noon"> <a href="adminNoticeWrite.php">공지사항 글쓰기</a></li>
            <li ><a href="adminDownWrite.php">자료실 글쓰기</a></li>
</ul>
           
<ul>                        <li ><a href="adminDeleteNotice.php">공지사항 글 삭제</a></li>
                        <li><a href="adminDeleteComm.php">자료실 글 삭제</a></li></ul>
        ...
        <div id="right">
          ...
          <div id="btn">
            <button class="btn1" id="add">글쓰기</button>
          </div>
      ...
      add.addEventListener("click", () => {
        fetch("/backend/addNotice.php", {
          ...
          body: JSON.stringify({
            ...
            content: noticeContent.value.replace(/(?:\r\n|\r|\n)/g, '<br>'),
            date: new Date(),
          }),
        })
          .then((res) => res.json())
