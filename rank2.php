      ...
      <div id="tab">
        <div class="inner">
          ...
          <li  onclick="self.location.href='rank.php'">조회수랭킹</li>
            <li   class="line" onclick="self.location.href='rank2.php'">확정랭킹</li>
      ...
      fetch("/backend/rank.php", {
        ...
        .then((data) => {
          ...
          async function fetchData2() {
            ...
            const big_data = `
                ...
                <span id="${
                  element["pk"]
                    ...
                    </span><br><span class="score" id="confirmed2Value_${
                      element["pk"]
                    }" >${element["cc"]-1}</span>
            ...
            const small_data = `
                ...
                <tr>
                  ...
                  local_fire_department
                  </span><br><span id="confirmed2Value2_${
                    element["pk"]
          ...
          const interval = setInterval(() => {
            ...
            let confirmed_small =
              document.querySelectorAll(".confirmed_small2");
