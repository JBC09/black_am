...
<html lang="ko">
  ...
  <body>
    ...
    <script>
      ...
      //             local_fire_department
      //             </span><br><span id="confirmed2Value2_${element["pk"]}" class="score" >${element["cc"]-1}</span>
      //             </td>
      //           </tr>
      ...
      //           </span><br><span class="score" id="confirmed3Value_${element["pk"]}">${element["cc"]-1}</span>
      //     <td>${element["check_number"]}</td>
      //   </tr>
      //   <tr>
      //       <td colspan='2' class="popo">${element["black_desc"] != "" ? element["black_desc"] : "•"}</td>
      ...
      //       local_fire_department
      //       </span ><br><span class="score" id="confirmed3Value2_${element["pk"]}">${element["cc"]-1}</span>
      //       </td>
      //   </tr>
