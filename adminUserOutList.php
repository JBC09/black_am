...
<head>
    ...
    <title>블랙아머</title>
    <link rel="stylesheet" href="css/adminUserOutList.css" tpye="text/css">
            ...
            <div id="main">
                <div id="left">
                    ...
                    <ul>
                        ...
                        <li id="noon"><a href="adminUserOutList.php">탈퇴목록</a></li>
                    </ul>
                   ...
                   <table>
                        ...
                        <tbody id="tableBody">
                            ...
                            <tr>
                                ...
                                <td><button class="btn">복구</button></td>
                            </tr>
...
const tableBody = document.querySelector("#tableBody");
    ...
    idSearch.addEventListener('click',()=>{
        ...
        data.forEach(element => {
                ...
                <tr id="tr${element[0]}">
                    ...
                    <td><button class="btn oks" id="${element[0]}">복구</button></td>
                </tr>
                `
    ...
    fetch("/backend/deleteUserList.php")
    .then((res)=> res.json())
    .then((data) => {
        console.log(data);
