  ...
  <body>
    ...
    <div id="wrap">
      ...
      <div id="tab">
        <div class="inner">
          <ul id="t_btn">
            <li onclick="self.location.href='notice.php'">공지사항</li>
            <li class="line">자료실</li>
          </ul>
          <div id="t_con">
            <div id="tab1">
              <!-- <table id="big">
...
<!-- 
    ...
    <script>
        ...
        left.addEventListener("click", () => {
          ...
          self.location.href=`notice2.php?id=${parseInt(url.searchParams.get("id"))-1}`  
        });

        right.addEventListener("click", () => { 
          const idx = parseInt(url.searchParams.get("id") == null ? 1 :url.searchParams.get("id") )+1;
   
          self.location.href=`notice2.php?id=${parseInt(idx)}`;  
        });
        ...
        for (let i = 0; i < elementIds.length; i++) {
            ...
            element.addEventListener("click", () => {
                self.location.href = `./notice2.php?id=${element.textContent}`;
            });
        }
        ...
        function truncateText(text, maxLength) {
          ...
          fetch("/backend/fileNoticeLimit.php",{
            method: "POST",
            headers: {
